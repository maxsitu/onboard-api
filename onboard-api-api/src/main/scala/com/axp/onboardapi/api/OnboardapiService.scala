package com.axp.onboardapi.api
...
object OnboardapiService {
  val TOPIC_NAME = "greetings"
}

/**
 * The onboard-api service interface.
 * <p>
 * This describes everything that Lagom needs to know about how to serve and
 * consume the OnboardapiService.
 */
trait OnboardapiService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("onboard-api")
      ...
      .withTopics(
        topic(OnboardapiService.TOPIC_NAME, greetingsTopic _)
